...
window.PROJECT_SHEET_DEMO = {
  ...
  tables: {
    ...
    ARBITRAGES_DECISIONS: [
      { id: 501, Projet: 1, Date_MAJ: "2026-08-24", Sujet: "Organisation du stationnement", Type: "Décision politique", Contexte: "Le plan-guide doit fixer un principe durable.", Question_a_trancher: "Quel niveau de mutualisation retenir ?", Options: "Parking mutualisé en entrée de quartier ; poches de proximité réparties.", Position_elue: "Privilégier la qualité paysagère et limiter la voiture en cœur de quartier.", Urgence: "Haute", Echeance_decision: "2026-09-12", Statut: "À décider", A_decider: true, Point_hebdo: true, Decision_prise: "", Date_decision: null, Instance_decision: "", Decision_par: null },
      { id: 502, Projet: 1, Date_MAJ: "2026-08-18", Sujet: "Principe du mail planté", Contexte: "La composition paysagère a été présentée en comité.", Question_a_trancher: "Valider le mail planté ?", Options: "", Position_elue: "", Urgence: "Normale", Echeance_decision: "2026-08-20", Statut: "Décidée", Point_hebdo: false, Decision_prise: "Le mail planté est validé.", Date_decision: "2026-08-22", Instance_decision: "Comité de pilotage", Decision_par: 11 },
    ],
  },
};
