...
window.PROJECT_SHEET_DEMO = {
  ...
  tables: {
    ...
    ATTENTES_EXTERNES: [{id:704,Projet:1,Attente:"Avis du service gestionnaire de voirie",Tiers:12,Date_attendue:"2026-09-20",Statut:"En attente",Date_fin:null,Resultat:""}],
    RELANCES_ATTENTES: [{id:705,Attente:704,Date_relance:"2026-09-10",Note:"Premier rappel envoyé."}],
    AVANCEMENTS: [
