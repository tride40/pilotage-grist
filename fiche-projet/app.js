...
async function fetchMetadata() {
  try {
    ...
    const details = Object.fromEntries(["PROJETS", "AVANCEMENTS", "ARBITRAGES_DECISIONS","JALONS","BLOCAGES","VIGILANCES","ATTENTES_EXTERNES","RELANCES_ATTENTES"].map((table) => [table, new Map(byTable(table).map((column) => [column.colId, column]))]));
