window.INSTRUCTIONS_DEMO_DATA = { tables: {
  ...
  SERVICES: [{id:21,Nom_service:"Services techniques",Actif:true},{id:22,Nom_service:"Communication",Actif:true}],
  ...
  CONSIGNES_POLITIQUES: [
    ...
    { id: 202, Projet: 1, Consigne: "Présenter le phasage des travaux aux commerçants.", Statut: "Active", Emetteur: 11, Services_destinataires: ["L",21], Date_emission: "2026-08-18" },
