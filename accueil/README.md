...
Le widget `accueil` sert de porte d’entrée vers les sept pages métier du même document Grist. Il ne lit ni ne modifie aucune donnée.
...
const PAGE_URLS = Object.freeze({
  ...
  instructions: "https://docs.getgrist.com/abc123/p/11",
